      ...
      <div className="flex pt-4 flex-row">
        <div className="flex flex-row flex-1 gap-2">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
             <path d="M13 9V13H3V3H7V1H3C1.89543 1 1 1.89543 1 3V13C1 14.1046 1.89543 15 3 15H13C14.1046 15 15 14.1046 15 13V9H13ZM15 1H11V3H13.5858L8.29289 8.29289L9.70711 9.70711L15 4.41421V7H17V1H15Z" fill="black"/>
          </svg>
